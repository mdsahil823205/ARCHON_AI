    ...
    return (
          ...
          ================================================== */}
            ...
            ============================================== */}
                        ...
                        <motion.button
                            ...
                            className="flex h-9 shrink-0 cursor-pointer items-center gap-1.5 rounded-lg bg-[var(--btn-primary-bg)] px-3 text-xs font-semibold text-[var(--btn-primary-text)] shadow-lg shadow-blue-500/10 transition-all hover:bg-[var(--btn-primary-hover)] sm:h-10 sm:px-4 sm:text-sm"
                        >
                            <PackagePlus size={16} />
                        ...
                        {userData && (
                            <div className="relative">
                                ...
                                <motion.button
                                    ...
                                    className="flex cursor-pointer items-center gap-2 rounded-lg border border-[var(--border-primary)] bg-[var(--hover-bg)] p-1 transition-all hover:border-[var(--border-hover)] hover:bg-[var(--hover-bg-strong)]"
                                >
                                    <img
                                        src={
                                            userData.avatar ||
                                    ...
                                    <ChevronDown
                                        size={15}
                                        className={`mr-1 hidden text-[var(--text-faint)] transition-transform duration-200 sm:block ${isProfileOpen
                                            ? "rotate-180"
                                            : ""
                                            }`}
                                    />
                                ...
                                <AnimatePresence>
                                    {isProfileOpen && (
                                        <motion.div
                                            ...
                                            className="absolute right-0 top-full z-50 mt-2 w-[calc(100vw-2rem)] max-w-64 overflow-hidden rounded-xl border border-[var(--border-primary)] bg-[var(--dropdown-bg)]"
                      ...
                      ==================================== */}
                                            ...
                                            <div className="p-3 md:hidden">
                                                <button
                                                    ...
                                                    className="flex w-full cursor-pointer items-center justify-between rounded-lg border border-[var(--border-primary)] bg-[var(--hover-bg)] px-3 py-2.5 transition-colors hover:bg-[var(--hover-bg-strong)]"
                                                >
      ...
      ====================================================== */}
            ...
            <main className="relative min-h-[calc(100vh-68px)] overflow-hidden">
                ...
                <div className="pointer-events-none absolute left-1/2 top-[-220px] h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-blue-500/[0.06] blur-[120px]" style={{ opacity: "var(--bg-glow-opacity)" }} />

                <div className="pointer-events-none absolute right-[-180px] top-[35%] h-[300px] w-[300px] rounded-full bg-violet-500/[0.035] blur-[110px]" style={{ opacity: "var(--bg-glow-opacity)" }} />
          ...
          ================================================== */}
                    ...
                    >
                        ...
                        <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                            ...
                            <div>
                                <h1 className="break-words text-3xl font-semibold tracking-tight text-[var(--text-primary)] sm:text-4xl md:text-5xl">
                                    Welcome back
                                    {userData?.name ? (
                                        <span className="text-[var(--text-heading-accent)]">
                                            , {userData.name}
                                        </span>
                                    ) : null}
                                </h1>
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="flex h-9 w-fit cursor-pointer items-center gap-2 rounded-lg border border-[var(--border-primary)] bg-[var(--hover-bg)] px-3 text-xs font-medium text-[var(--text-muted)] transition-all hover:bg-[var(--hover-bg-strong)] hover:text-[var(--text-primary)] disabled:cursor-not-allowed disabled:opacity-50"
                            >
                                <RefreshCw
                                    size={14}
                    ...
                    {loading && (
                        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                            {[1, 2, 3].map((item) => (
                                <div
                                    key={item}
                                    className="overflow-hidden rounded-2xl border border-[var(--border-primary)] bg-[var(--bg-elevated)]"
                                >
                                    {/* Preview skeleton */}
                                    <div className="h-52 animate-pulse bg-[var(--skeleton-shine)] sm:h-56" />

                                    {/* Content skeleton */}
                                    <div className="space-y-4 p-5">
                                        <div className="h-4 w-2/3 animate-pulse rounded bg-[var(--skeleton-bg)]" />

                                        <div className="h-3 w-1/2 animate-pulse rounded bg-[var(--skeleton-bg)]" />

                                        <div className="flex gap-2">
                                            <div className="h-9 flex-1 animate-pulse rounded-lg bg-[var(--skeleton-bg)]" />

                                            <div className="h-9 w-10 animate-pulse rounded-lg bg-[var(--skeleton-bg)]" />
                                        </div>
                                    </div>
                                </div>
                            ))}
                    ...
                    {!loading && error && (
                        ...
                        >
                            ...
                            <button
                                type="button"
                                onClick={handleGetAllWebsite}
                                className="mt-5 flex cursor-pointer items-center gap-2 rounded-lg bg-[var(--btn-primary-bg)] px-4 py-2.5 text-sm font-semibold text-[var(--btn-primary-text)] transition-colors hover:bg-[var(--btn-primary-hover)]"
                            >
                                <RefreshCw size={15} />
                    ...
                    {!loading &&
                        ...
                        websiteData.length === 0 && (
                            <motion.div
                                ...
                                className="flex min-h-[400px] flex-col items-center justify-center rounded-2xl border border-dashed border-[var(--border-primary)] bg-[var(--hover-bg)] px-5 text-center"
                            >
          ...
          ================================================== */}
                            ...
                            <div className="grid grid-cols-2 gap-2 sm:gap-3 md:grid-cols-3 md:gap-4 xl:grid-cols-3">
                                {websiteData.map((web, index) => (
                                    <motion.article
                                        ...
                                        className="group min-w-0 overflow-hidden rounded-md border border-[var(--border-primary)] bg-[var(--bg-elevated)] transition-all duration-300 hover:border-blue-500/20 sm:rounded-xl"
                    ...
                    ================================================== */}
                                        ...
                                        <div className="relative aspect-[4/2] w-full overflow-hidden border-b border-[var(--border-primary)] bg-white">
                                        ...
                                        <div className="p-2 sm:p-3 md:p-4">
                                            ...
                                            >
                                                <div className="min-w-0 flex-1">
                                                    <h2 className="truncate text-[10px] font-semibold leading-4 text-[var(--text-primary)] sm:text-xs md:text-sm">
                                                        {web?.title || "Untitled Website"}
                                                    </h2>

                                                    <p className="font-medium mt-0.5 xl:mt-1.5 truncate text-[7px] text-[var(--text-faint2)] sm:text-[9px] md:text-[10px]">
                                                       Last Update - {formatDate(web?.updatedAt)}
                                                    </p>
                                                </div>
                                                ...
                                                <button
                                                    ...
                                                    className="flex h-5 w-5 shrink-0 cursor-pointer items-center justify-center rounded-md text-[var(--text-faint)] transition-colors hover:bg-[var(--hover-bg-strong)] hover:text-[var(--text-primary)] sm:h-6 sm:w-6"
                                                    title="More options"
                                                >
                                                    <MoreHorizontal
                                                        size={12}
                                            ...
                                            <div className="mt-2 flex gap-1 sm:mt-3 sm:gap-1.5">
                                                ...
                                                {!web?.deployed ? (
                                                    ...
                                                    <button
                                                        ...
                                                        type="button"
                                                        className="flex h-7 min-w-0 flex-1 cursor-pointer items-center justify-center gap-1 rounded-md bg-[var(--btn-primary-bg)] px-1 text-[7px] font-semibold text-[var(--btn-primary-text)] transition-colors hover:bg-[var(--btn-primary-hover)] sm:h-8 sm:gap-1.5 sm:rounded-lg sm:text-[9px] md:h-9 md:text-[10px]"
                                                ...
                                                <button
                                                    ...
                                                    type="button"
                                                    className="flex h-7 w-7 shrink-0 cursor-pointer items-center justify-center rounded-md border border-[var(--border-primary)] bg-[var(--hover-bg)] text-[var(--text-faint)] transition-colors hover:bg-[var(--hover-bg-strong)] hover:text-[var(--text-primary)] sm:h-8 sm:w-8 sm:rounded-lg md:h-9 md:w-9"
                                                    title="Open website"
                                                >
                                                    <ExternalLink
                                                        size={10}
