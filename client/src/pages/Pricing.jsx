  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-[#09090b] text-white">
      ...
      <motion.header
        ...
        className="sticky top-0 z-50 border-b border-white/[0.08] bg-[#09090b]/90 backdrop-blur-xl"
      >
      ...
      <main className="relative z-10">
        ...
        <section className="mx-auto max-w-6xl px-4 pb-10 pt-14 text-center sm:px-6 sm:pb-12 sm:pt-20 lg:px-8">
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-3.5 py-2 text-xs font-medium text-gray-400"
          >
            <Sparkles size={13} />
          ...
          <motion.h1
            ...
            className="mx-auto mt-5 max-w-3xl text-4xl font-semibold tracking-tight text-white sm:text-5xl md:text-6xl"
          >
            Build more.
          ...
          <motion.p
            ...
            className="mx-auto mt-5 max-w-xl text-sm leading-6 text-gray-500 sm:text-base"
          >
          ...
          {pricingPlans.map((plan, index) => {
            ...
            return (
              <motion.article
                ...
                whileHover={{ y: -4 }}
                className={`relative flex flex-col overflow-hidden rounded-2xl border bg-[#111214] ${
                  plan.popular
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5 sm:p-6">
                  ...
                  {/* Credits */}
                  <div className="mt-5 flex items-center rounded-xl border border-white/[0.07] bg-white/[0.025] px-3 py-3">
                    <div className="flex items-center gap-2">
                  ...
                  <motion.button
                    ...
                    className={`mt-4 flex h-11 w-full cursor-pointer items-center justify-center gap-2 rounded-xl text-sm font-semibold transition-all ${
                      plan.popular
